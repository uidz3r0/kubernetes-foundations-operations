...
Questions:
    ...
    Think:
        ...
        Smallest deployable unit and contains one or more containers that share networking and storage context.
    ...
    1. Why are there pods before I deploy anything?
    ...
    1. What does kubectl get pods -A show me? 
    ...
    1. Bonus: What lives in the control plane?
...
Questions:
    ...
    Why are Deployments preferred over standalone Pods?
